// observations:
// you will try to use borders cause we can always go to change inside 
// but changing borders can be hard 
// we should try to use stamps backwards like in example 
// at border 3 ,at border 0 then in middle 1
