//if(n==5)then m can be (4,5,6) only.
//if one string is broken into n parts then other string will definetly be broken into (n-1),n,(n+1) parts.
//requirements for s3 to be true:-
